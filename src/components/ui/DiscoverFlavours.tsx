...
export default function DiscoverFlavours() {
  ...
  <div className="space-y-2">
    <ImageCard src="/Memo1.png" height="h-[300px]" />
    <ImageCard src="/Memo4.png" height="h-[320px]" />
    <ImageCard src="/per3.png" height="h-[160px]" />
  </div>

  {/* Column 2 */}
  <div className="space-y-2">
    <ImageCard src="/Memo2.png" height="h-[240px]" />
    <ImageCard src="/per.png" height="h-[230px]" />
    <ImageCard src="/per2.png" height="h-[180px]" />
  </div>

  {/* Column 3 */}
  <div className="space-y-2">
    <ImageCard src="/Memo3.png" height="h-[240px]" />
    <ImageCard src="/Memo5.png" height="h-[260px]" />
    <ImageCard src="/Memo2.png" height="h-[250px]" />
  </div>
